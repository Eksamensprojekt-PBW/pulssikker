$swal2-white: #eeeeee !default;
$swal2-black:  #1b232e !default;
...
$swal2-box-shadow: #e4e4e4 !default;
...
$swal2-success: #249e1f !default;
$swal2-success-border: rgba($swal2-success, 0.3) !default;
$swal2-error: #f03a3a !default;
$swal2-warning: #f99128 !default;
$swal2-info: #05ace4 !default;
...
$swal2-confirm-button-background-color: #200dea !default;
...
$swal2-cancel-button-background-color: #7a7e81 !default;
